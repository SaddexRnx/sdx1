      ...
      <div className="bg-white border-b-pixel border-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-black">{t('pages.gpts.title')}</h1>
          </div>
          <p className="text-pixel-gray-500 font-mono">{t('pages.gpts.description')}</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {tools.length === 0 && !loading ? (
          <div className="text-center py-16 bg-white border-pixel p-12">
            <Sparkles className="w-16 h-16 text-pixel-gray-300 mx-auto mb-4" strokeWidth={2} />
            <p className="text-xl font-bold text-black mb-2 uppercase">{t('pages.gpts.empty')}</p>
          </div>
        ) : (
          <>
            <div className="mb-6">
